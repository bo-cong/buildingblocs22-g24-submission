...
def show_predict_page():
    ...
    topic2=('Work, Energy and Power','Measurements','Kinematics','Dynamics','Forces','Motion in a circle','Functions',
     'Price Mechanisms and its applications','Market Failure','Graphs and Transformations','Vectors','Central Economic Problem'
)
    topic3=('Work, Energy and Power','Measurements','Kinematics','Dynamics','Forces','Motion in a circle','Functions',
     'Price Mechanisms and its applications','Market Failure','Graphs and Transformations','Vectors','Central Economic Problem'
)
    la1=('U','S',"E",'D','C','B','A')
    la2=('U','S',"E",'D','C','B','A')
    ...
    top2=st.selectbox("Topic 2",topic2)
    top3=st.selectbox("Topic 3",topic3)
